...
public class ReportController implements Initializable {// 00174323: Definir la clase que implementa Initializable
    ...
    @FXML
    private TextField facilitadorField;// 00174323: Anotación para inyectar el campo desde el archivo FXML

    @FXML
    private Button generarReporteButton; // 00174323: Anotación para inyectar el campo desde el archivo FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        generarReporteButton.setOnAction(event -> generarReporte());// 00174323: Configura la acción del botón para generar el reporte
    }
