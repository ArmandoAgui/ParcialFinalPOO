...
//Consulta para reporte A
select c.nombreCompleto as Nombre, c.direccion as Domicilio, c.telefono as Telefono,
...
inner join Transacciones T on tj.id = T.tarjetaId where c.id = 1 and DATE(T.fecha) between '2024-01-01' and '2024-06-01';